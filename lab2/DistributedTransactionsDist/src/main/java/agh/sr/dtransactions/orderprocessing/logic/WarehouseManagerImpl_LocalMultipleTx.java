 ...
 * Author: Piotr Turek
 */
public class WarehouseManagerImpl_LocalMultipleTx implements WarehouseManagerService_ConnPassing {
    private DataSource productDS;

    private ProductDao_ConnPassing productDao;

    public WarehouseManagerImpl_LocalMultipleTx(DataSource productDS, ProductDao_ConnPassing productDao) {
