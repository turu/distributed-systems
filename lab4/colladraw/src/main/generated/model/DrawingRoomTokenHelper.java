...
/**
* model/DrawingRoomTokenHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from api.idl
* Tuesday, May 6, 2014 12:57:50 AM CEST
*/

abstract public class DrawingRoomTokenHelper
{
  private static String  _id = "IDL:model/DrawingRoomToken:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (model.DrawingRoomTokenHelper.id (), "DrawingRoomToken", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    model.DrawingRoomToken value = new model.DrawingRoomToken ();
