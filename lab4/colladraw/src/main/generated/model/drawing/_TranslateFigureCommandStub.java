...
/**
* model/drawing/_TranslateFigureCommandStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from api.idl
* Tuesday, May 6, 2014 12:57:50 AM CEST
*/

public class _TranslateFigureCommandStub extends org.omg.CORBA.portable.ObjectImpl implements model.drawing.TranslateFigureCommand
{
  ...
  public model.figures.Point[] getTranslation ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTranslation", true);
                $in = _invoke ($out);
                model.figures.Point $result[] = model.drawing.TranslationSeqHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
